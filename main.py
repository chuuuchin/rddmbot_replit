...
### * Written by Dmitriy Chuchin <chuuchin@yandex.ru>, April 2023
###
...
def start(message):
  bot.send_message(message.chat.id, 'Привет, это бета-версия Первобота для московского отделения Движения Первых.')
  bot.send_message(message.chat.id, 'Для начала зарегистрируйтесь - /register. Если вы уже зарегистрированы - войдите - /login.')
  
@bot.message_handler(commands=['register'])
def register(message):
  bot.send_message(message.chat.id, 'Итак, давай тебя зарегистрируем. Для начала определимся с полом. Ты мальчик - /boy - или девочка - /girl - ?')
  @bot.message_handler(commands=['boy'])
  def boy(message):
    bio = bot.send_message(message.chat.id, 'В следующем сообщении напиши о себе и своё имя пользователя (@...). Только пожалуйста, без всяких переносов строк. Ты же не хочешь, чтобы твои данные смешались с другими?\nВот пример: "Дмитрий, м, 14 лет, увелкаюсь программированием, живу в Яндекс.Лицее, @chuuuchin"')
  ...
  def directionboy(message):
    ...
    bot.send_message(message.chat.id, 'Теперь определим направление. Выше я отправил список. Ознакомься с ним и выбери то, что тебе по душе:\
    ...
    def educationdirectionboy(message):
      ...
      bot.send_sticker(message.chat.id, 'CAACAgIAAxkBAAEIe1ZkLuPsUkhjaWJSgktAqOPtcyGeQwACdQADBc7CLbvpsgAB1nSKSy8E')
      bot.send_message(message.chat.id, 'Готово, ты зарегистрирован! Выбирай, куда отправимся:\
  ...
  def directiongirl(message):
    ...
    def educationdirectiongirl(message):
      ...
      file3.write(str(message.from_user.username) + '\n')
      bot.send_sticker(message.chat.id, 'CAACAgIAAxkBAAEIe1ZkLuPsUkhjaWJSgktAqOPtcyGeQwACdQADBc7CLbvpsgAB1nSKSy8E')
      bot.send_message(message.chat.id, 'Готово, ты зарегистрирована! Выбирай, куда отправимся:\
                    \nНовые знакомства - /newfriends\
                    \nЧаВО (Частые Вопросы и Ответы) - /faq\
                    \nСводка за неделю - /weeknews\
                    \nИнформация о съездах и т.д. - /meetout\
  ...
  for i in array:
    if message.from_user.username in i:
      ...
      bot.send_message(message.chat.id, 'Выбирай, куда отправимся:\
                    ...
                    \n\nДля открытия этого меню - /menu')
      break
  bot.send_message(message.chat.id, 'Если тебе не выпало сообщение об удачном входе, то ты ещё не зарегистрирован в боте. Выполни /start заново и зарегистрируйся.')
...
def newfriends(message):
  ...
  def randomnewfriends(message):
    bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findboy) или девочку (/findgirl)?\
                    \n\nДля возврата в меню - /menu')
  ...
  def interestsnewfriends(message):
    bot.send_message(message.chat.id, 'Выбери интерес, по которому будем искать:\
    ...
    def education(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findeducationboy) или девочку (/findeducationgirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findeducationboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findeducationboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findeducationgirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findeducationgirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['science'])
    def science(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findscienceboy) или девочку (/findsciencegirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findscienceboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findscienceboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findsciencegirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findsciencegirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['profession'])
    def profession(messgae):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findprofessionboy) или девочку (/findprofessiongirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findprofessionboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findprofessionboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findprofessiongirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findprofessiongirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['culture'])
    def culture(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findcultureboy) или девочку (/findculturegirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findcultureboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findcultureboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findculturegirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findculturegirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['volunteer'])
    def volunteer(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findvolunteerboy) или девочку (/findvolunteergirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findvolunteerboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findvolunteerboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findvolunteergirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findvolunteergirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['patriotism'])
    def patriotism(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findpatriotismboy) или девочку (/findpatriotismgirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findpatriotismboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findpatriotismboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findpatriotimgirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findpatriotismgirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['sport'])
    def sport(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findsportboy) или девочку (/findsportgirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findsportboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findsportboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findsportgirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findsportgirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['healthyhealth'])
    def healthyhealth(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findhealthyhealthboy) или девочку (/findhealthyhealthgirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findhealthyhealthboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findhealthyhealthboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findhealthyhealthgirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findhealthyhealthgirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      
    @bot.message_handler(commands=['media'])
    def media(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findmediaboy) или девочку (/findmediagirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findmediaboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findmediaboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findmediagirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findmediagirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
        
    @bot.message_handler(commands=['diplomacy'])
    def diplomacy(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/finddiplomacyboy) или девочку (/finddiplomacygirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def finddiplomacyboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /finddiplomacyboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def finddiplomacygirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /finddiplomacygirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
    
    @bot.message_handler(commands=['ecology'])
    def ecology(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findecologyboy) или девочку (/findecologygirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findecologyboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findecologyboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findecologygirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findecologygirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
    
    @bot.message_handler(commands=['tourism'])
    def tourism(message):
      bot.send_message(message.chat.id, 'Кого будем искать - мальчика (/findtourismboy) или девочку (/findtourismgirl)?\
                    \n\nДля возврата в меню - /menu')
      ...
      def findtourismboy(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findtourismboy')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
      ...
      def findtourismgirl(message):
        ...
        temp = random.randint(0, len(array) - 1)
        bot.send_message(message.chat.id, array[temp])
        bot.send_message(message.chat.id, 'Можешь повторить поиск: /findtourismgirl')
        bot.send_message(message.chat.id, 'Для возврата в меню - /menu')
  ...
  def anonymousnewfriends(message):
    ...
    array = line.split('\n')
    temp = random.randint(0, len(array) - 1)
    bot.send_message(message.chat.id, 'Вот ссылка на него/неё: ' + '@' + array[temp])
...
def createfq(message):
  newfq = bot.send_message(message.chat.id, 'В следующем сообщении отправь вопрос, который должен появиться в списке, и ответ на него.\nДля возврата в меню - /menu')
...
def createfq1(message):
  ...
  if data == '/menu':
    ...
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Готово! Скоро твой вопрос появится в списке!')

@bot.message_handler(commands=['info'])
def info(message):
  bot.send_message(message.chat.id, 'Проект бота был создан 7 марта 2023 года Чучиным Д. М. и Богдановым М. Ю. в качестве чат-бота для связи всего Движения.\n\n© Чучин Д. М., Богданов М. Ю., 2023')

@bot.message_handler(commands=['weeknews'])
def weeknews(message):
  bot.send_message(message.chat.id, 'В этой сводке новостей ты сможешь ознакомиться со всеми событиями на этой неделе!\
...
def links(message):
  bot.send_message(message.chat.id, 'Основной чат "РДДМ Москва" - https://t.me/rddm_moscow\
...
def feedback(message):
  bot.send_message(message.chat.id, 'Переходи по ссылке и оставляй обратную связь - https://forms.yandex.ru/u/641dd640eb61460571ab62a2/\
                    \n\nДля возврата в меню - /menu')
...
def donate(message):
  bot.send_message(message.chat.id, 'Топ донатеров - /topdonations\
                    \nЗадонатить, если хочешь - /senddonation\
                    \n\nДля возврата в меню - /menu')
  @bot.message_handler(commands=['topdonations'])
  def topdonations(message):
    bot.send_message(message.chat.id, 'Тут будет топ донатов.\
                      \n\nДля возврата в меню - /menu')
  @bot.message_handler(commands=['senddonation'])
  def senddonation(message):
    bot.send_message(message.chat.id, 'Если хочешь поблагодарить разработчиков за работу, можешь отправить любую сумму по этому номеру - 2200700767044562 - мы будем очень рады!\
                      \n\nДля возврата в меню - /menu')
...
def edit_data(message):
  ...
  def edit_nickname(message):
    new_nickname = bot.send_message(message.chat.id, 'Для начала введи своё старое имя пользователя, а потом через пробел - новое.')
  ...
  def edit_nickname1(message):
    ...
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Готово, после недолгой модерации твоё имя пользователя поменяется!\
                      \n\nДля возврата в меню - /menu')

  @bot.message_handler(commands=['edit_name'])
  def edit_name(message):
    new_name = bot.send_message(message.chat.id, 'Для начала введи своё имя пользователя, а потом через пробел - новое имя.')
    bot.register_next_step_handler(new_name, edit_name1)
  def edit_name1(message):
    data = message.text
    file = open('edit_name.txt', 'a+', encoding='utf-8')
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Готово, после недолгой модерации твоё имя поменяется!\
                      \n\nДля возврата в меню - /menu')

  @bot.message_handler(commands=['edit_about'])
  def edit_about(message):
    new_about = bot.send_message(message.chat.id, 'Для начала введи своё старое имя пользователя, а потом через пробел - новые данные.')
    bot.register_next_step_handler(new_about, edit_about1)
  def edit_about1(message):
    data = message.text
    file = open('edit_about.txt', 'a+', encoding='utf-8')
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Готово, после недолгой модерации данные о тебе поменяются!\
                      \n\nДля возврата в меню - /menu')

  @bot.message_handler(commands=['edit_direction'])
  def edit_direction(message):
    new_direction = bot.send_message(message.chat.id, 'Для начала введи своё имя пользователя, а потом - новое/новые направления.')
  ...
  def edit_direction1(message):
    ...
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Готово, после недолгой модерации твои направления поменяются!\
                      \n\nДля возврата в меню - /menu')

@bot.message_handler(commands=['create_extra_profile'])
def create_extra_profile(message):
  data = bot.send_message(message.chat.id, 'Так как профиль расширенный, все данные в нём будут проверяться, это может занять некоторое время. В следующем сообщении отправь любую информацию, которые ты хотел бы видеть в своём профиле.\nКак пример: район Лефортово, школа Содружество, 8 класс.\nДля возврата в меню - /menu')
...
def create_extra_profile1(message):
  ...
  if data == '/menu':
    ...
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Круто! Скоро твой профиль обновится! Если появятся какие-то вопросы, мы тебе напишем.')
    bot.send_message(6220998434, data)


@bot.message_handler(commands=['ads'])
def ads(message):
  bot.send_message(message.chat.id, 'Хочешь прорекламировать свой проект в нашем боте? Заполни эту форму - https://forms.yandex.ru/u/641dd78dc769f1054d12d502/ - или нажми сюда - /createadsrequest - мы с тобой свяжемся)\
                     \n\nДля возврата в меню - /menu')
...
def createadsrequest(message):
  name = bot.send_message(message.chat.id, 'Для начала следующим сообщением отправь своё имя.\nДля возврата в меню - /menu')
...
def createadsrequest2(message):
  ...
  file.write(str(data) + '\n')
  username = bot.send_message(messgae.chat.id, 'Теперь отправь своё имя пользователя в ТГ (@...)\nДля возврата в меню - /menu')
...
def createadsrequest3(message):
  ...
  file.write(str(data) + '\n')
  thought = bot.send_message(message.chat.id, 'В следующем сообщении опиши свой проект - напиши название, суть и т.д.\nДля возврата в меню - /menu')
...
def createadsrequest4(message):
  ...
  file.write(str(data) + '\n')
  username = bot.send_message(message.chat.id, 'Отлично! Скоро с тобой свяжется один из наших менеджеров!\nДля возврата в меню - /menu')
...
def createbugreport2(message):
  ...
  if data == '/menu':
    ...
    file.write(str(data) + '\n')
    username = bot.send_message(message.chat.id, 'Теперь отправь своё имя пользователя в ТГ (@...)\nДля возврата в меню - /menu')
...
def createbugreport3(message):
  ...
  if data == '/menu':
    ...
    file = open('bug_reports.txt', 'a+', encoding='utf-8')
    file.write(str(data) + '\n')
    bug = bot.send_message(message.chat.id, 'В следующем сообщении опиши ошибку.\nДля возврата в меню - /menu')
...
def createbugreport4(message):
  ...
  if data == '/menu':
    ...
    file = open('bug_reports.txt', 'a+', encoding='utf-8')
    file.write(str(data) + '\n')
    bot.send_message(message.chat.id, 'Отлично! Скоро с тобой свяжется один из наших менеджеров!\nДля возврата в меню - /menu')


@bot.message_handler(commands=['all_admin_panel'])
def all_admin_panel(message):
  bot.send_message(message.chat.id, 'Выбери один из пунктов:\
...
def passwordhidenewfqs(message):
  password = bot.send_message(message.chat.id, 'Введи пароль для доступа к этой функции.')
