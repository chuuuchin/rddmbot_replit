...
bot = telebot.TeleBot('6336258739:AAGCAJ3XPqeop_BCXzVjhvZfccKI56SAFyU')
...
def register(message):
  ...
  def directionboy(message):
    ...
    def educationdirectionboy(message):
      ...
      bot.send_message(
        message.chat.id,
        'Готово, ты зарегистрирован! Обязательно вступи в чат пользователей, там много анонсов и просто уютно - t.me/pervobotusers! Выбирай, куда отправимся:\
  ...
  def directiongirl(message):
    ...
    def educationdirectiongirl(message):
      ...
      bot.send_message(
        message.chat.id,
        'Готово, ты зарегистрирована! Обязательно вступи в чат пользователей, там много анонсов и просто уютно - t.me/pervobotusers! Выбирай, куда отправимся:\
                    \nНовые знакомства - /newfriends\
                    \nЧаВО (Частые Вопросы и Ответы) - /faq\
                    \nИнформация о съездах и т.д. - /meetout\
                    \nСсылки - /links\
